aef_style <- function() {
  ...
  ggplot2::theme(
    ...
    plot.title = ggplot2::element_text(family = font, size = 28, face = "bold", color = "#000000"),
    ...
    plot.subtitle = ggplot2::element_text(family = font, size = 22, color = "#000000", margin = ggplot2::margin(9, 0, 9, 0)),
    # This sets the font, size, type and color of text for the chart's caption
    plot.caption = ggplot2::element_text(family = font, size = 18, color = "#908e95"),
    # Legend format:
    ...
    legend.text = ggplot2::element_text(family = font, size = 18, color = "#000000"),
    # Axis format:
    ...
    strip.text = ggplot2::element_text(family = font, size = 22, color = "#000000", hjust = 0)
  )
}
